...
Image.fromarray(mon_image).save("chat1.png") #image sans bleu et vert

########################################################################

image_2=Image.open("chat.png")
...
Image.fromarray(mon_image2).save("chat2.png") # image inversée horizontalement

########################################################################

image_3=Image.open("chat.png")
...
Image.fromarray(mon_image3).save("chat3.png") # image inversée verticalement

########################################################################

image_4=Image.open("chat.png")
...
Image.fromarray(mon_image4).save("chat4.png") # image inversée diagolament

########################################################################

image_5=Image.open("chat.png")
...
Image.fromarray(mon_image5).save("chat5.png") # image gris 1

########################################################################

image_6=Image.open("chat.png")
mon_image6=np.asarray(image_6)
nb_lignes6, nb_colonnes6, _6= mon_image6.shape



Image.fromarray(mon_image6).save("chat6.png") # image gris 2